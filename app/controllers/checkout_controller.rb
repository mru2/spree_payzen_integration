...
class CheckoutController < Spree::BaseController
  ...
  # ----------------------------------------------------------------------------------------------------------------------
  # | ID | From Payzen                 |  Order initial  | Order final |  Payment initial | Payment final  |  Payzen     |    
  # ----------------------------------------------------------------------------------------------------------------------    
  # | A  | post without vads_order_id  |     *           |     *       |                  |                | 404         |    
  # |    | or order not found          |                 |             |                  |                |             |    
  # ----------------------------------------------------------------------------------------------------------------------    
  # | B  | post with order_id but      |  confirm        | canceled    |  checkout        |   fail         | 404         |    
  # |    | wrong signature             |                 |             |  error           |                |             |    
  # ----------------------------------------------------------------------------------------------------------------------    
  # | C  | post with wrong amount/curr |  confirm        | canceled    |  checkout/error  |   fail         | 404         |    
  # ----------------------------------------------------------------------------------------------------------------------    
